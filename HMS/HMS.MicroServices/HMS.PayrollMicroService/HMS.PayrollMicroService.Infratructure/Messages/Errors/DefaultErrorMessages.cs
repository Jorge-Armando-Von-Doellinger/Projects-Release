namespace HMS.PayrollMicroService.Infratructure.Messages.Errors
{
    internal record DefaultErrorMessages
    {
        ...
        internal static string TimeOutInTransaction = "Há muitas transações no momento e ocorreu um timeout. Por favor, tente novamente!";
    }
}
