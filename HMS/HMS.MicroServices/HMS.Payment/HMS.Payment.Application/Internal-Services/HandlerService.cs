...
public sealed class HandlerService
{
    ...
    private void AddPaymentHandler()
    {
        ...
        _handler.Add(GetSchema(SchemasDefaultKeysEnum.Payment_Update_Schema),
            new PaymentUpdateHandler(_paymentManager));
    }

    private void AddPaymentEmployeeHandler()
    {
        _handler.Add(GetSchema(SchemasDefaultKeysEnum.PaymentEmployee_Add_Schema),
            new PaymentEmployeeAddHandler(_paymentEmployeeManager));
        _handler.Add(GetSchema(SchemasDefaultKeysEnum.PaymentEmployee_Update_Schema),
            new PaymentEmplyoeeUpdateHandler(_paymentEmployeeManager));
    }
